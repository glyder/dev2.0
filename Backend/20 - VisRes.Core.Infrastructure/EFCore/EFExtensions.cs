...
namespace VisRes.Core.Infrastructure.EFCore
{
    /// <summary>
    /// https://github.com/snickler/EFCore-FluentStoredProcedure
    /// Nope I (GP) didn't write this but looks well maintained.
    /// Need this as temporary solution while waiting for EF Core 2.1 Query Types
    /// https://stackoverflow.com/questions/49525660/raw-sql-mapping-stored-procedure-results-to-poco-dto-using-entity-framework-core?rq=1
    /// </summary>
